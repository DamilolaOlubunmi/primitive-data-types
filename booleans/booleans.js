...
let notPlagiarised = studentEssay.includes(keyPhrase) === false
...
let codeIsValid = secretCode.charAt(4) >= 'A' && secretCode.charAt(4) <= 'Z' && secretCode.charAt(9) >= '0' && secretCode.charAt(9) <= '9' && secretCode.length === 15
